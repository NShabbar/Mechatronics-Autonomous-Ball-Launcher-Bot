...
uint8_t InitNavigateLoadHSM(void)
{
    ES_Event returnEvent;

    CurrentState = InitPSubState;
    returnEvent = RunNavigateLoadHSM(INIT_EVENT);
...
ES_Event RunNavigateLoadHSM(ES_Event ThisEvent)
{
    ...
    if (makeTransition == TRUE) { // making a state transition, send EXIT and ENTRY
        ...
        RunNavigateLoadHSM(EXIT_EVENT); // <- rename to your own Run function
        CurrentState = nextState;
        RunNavigateLoadHSM(ENTRY_EVENT); // <- rename to your own Run function
    }
